...
import pygame #importe la libreria 
import sys #aca sirve para salir del juego
...
pygame.display.set_caption("Pong v.0 Juan Cabrera Aprendizaje Autonomo 2")
...
while correr:
    ...
    #Empieza la velocidad del juego en FPS
    reloj.tick(FPS)

    #Manejamos los eventos aca, por ahora esto permite cerrar el juego
